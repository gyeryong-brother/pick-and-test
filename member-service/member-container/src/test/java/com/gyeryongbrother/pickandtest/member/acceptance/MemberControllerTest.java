...
class MemberControllerTest {
    ...
    void register() {
        // given
        RegisterMemberRequest registerMemberRequest = new RegisterMemberRequest("nickname", "profileImageUrl");
        RegisterMemberResponse expected = new RegisterMemberResponse(
                null,
