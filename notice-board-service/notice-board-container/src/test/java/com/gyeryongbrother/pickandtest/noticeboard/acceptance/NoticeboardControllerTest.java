...
public class NoticeboardControllerTest {
    ...
    void findAllPosts(){
        ...
        SimplePostResponse simplePostResponse1=new SimplePostResponse(postResult1.id(),postResult1.memberId(),postResult1.title(),null);
        SimplePostResponse simplePostResponse2=new SimplePostResponse(postResult2.id(),postResult2.memberId(),postResult2.title(),null);
        SimplePostResponse simplePostResponse3=new SimplePostResponse(postResult3.id(),postResult3.memberId(),postResult3.title(),null);
        PostsResponse expected=new PostsResponse(List.of(simplePostResponse1,simplePostResponse2,simplePostResponse3));
