...
public interface PortfolioService {
    ...
    PortfoliosResponse deletePortfolio(DeletePortfolioCommand deletePortfolioCommand);

    UpdatePortfolioResponse savePortfolio(SavePortfolioCommand savePortfolioCommand);
}
