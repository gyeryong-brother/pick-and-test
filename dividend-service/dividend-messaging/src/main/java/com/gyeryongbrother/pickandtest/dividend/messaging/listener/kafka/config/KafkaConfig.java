package com.gyeryongbrother.pickandtest.dividend.messaging.listener.kafka.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, StockCreatedEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "dividend-listener");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, StockCreatedEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, StockCreatedEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
